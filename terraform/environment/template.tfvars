...
customer_owned_domain = "REPLACE_ME" # Customer-Owned Domain registered in route53, this will be used to create endpoint DNS A records.
...
# In order to have uninterrupted service, number of replica must be at least 2, for 21-day mandatory drain.
# For dev this can cause a brief interruption at 1. For prod it should be at least 2.
